...
Aquest fitxer no és per a l'usuari — és evidència per al manteniment d'apunts-per-projectes-agentic. Si el teu projecte és públic o el comparteixis, pots enviar el fitxer a qui manté apunts-per-projectes-agentic. Si no, queda al teu projecte com a log intern.
...
> No és un inbox ni una petició formal — qui manté apunts-per-projectes-agentic el llegeix quan toca.
